#include <jmuduo/net/http/HttpContext.h>
#include <jmuduo/net/Buffer.h>
...
using jmuduo::net::HttpContext;
using jmuduo::net::HttpRequest;
...
using jmuduo::net::detail::parseRequest;
